    ...
    <div className="app" enable-xr-monitor>
      <header className="app-header" enable-xr>
        ...
        <div className="header-right">
          <a href="https://www.linkedin.com/in/qingyangliu0110/" target="_blank" rel="noopener noreferrer" className="header-link">
            DamonRamen
          </a>
          <a href="https://github.com/DamonRamen/PokieTickerWebSpatial" target="_blank" rel="noopener noreferrer" className="header-link header-github">
